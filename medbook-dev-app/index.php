...
$sql="INSERT INTO tbl_service(service_type, general_comments)
  VALUES ('$service_type',$general_comments)";
...
// $sql="INSERT INTO tbl_patient(patient_name, patient_dob
// VALUES
// ('$_POST[patient_name]','$_POST[patient_dob]')";
...
// $sql="INSERT INTO tbl_service(service_type, general_comments)
// VALUES
// ('$_POST[service_type]', '$_POST[general_comments]'";
...
<div class="container">
  ...
  <table class="table table-bordered">
    ...
    <tbody>
      <tr>
        <th><?php echo $_POST['patient_name']; ?></th>
        <th><?php echo $_POST['patient_dob']; ?></th>
        <th><?php echo $_POST['gender_type']; ?></th>
        <th><?php echo $_POST['service_type']; ?></th>
        <th><?php echo $_POST['general_comments']; ?></th>
      </tr>
    </tbody>
  </table>
</div>
